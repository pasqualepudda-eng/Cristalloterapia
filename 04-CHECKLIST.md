...
- [x] **MOD-115** (22:07) `[1 file]` — Da cambiare la foto con quella sopra Si parte da dove sei: non serve aver fatto gia' percorsi olistici ne' avere esperienza di …
...
- [x] **MOD-125** (10:33) `[1 file]` — Quando non e' in equilibrio ..non scoperto
- [x] **MOD-126** (10:35) `[1 file]` — Non chiuso ma sbilanciato
- [x] **MOD-127** (10:37) `[1 file]` — No alterato ma carente
- [x] **MOD-128** (10:38) `[1 file]` — Su entrambe a posto di chiuso sbilanciato
- [x] **MOD-129** (10:44) `[1 file]` — Intuito non muto ma quanto la tua connessione con l'intuito , la saggezza interiore, e' debole o ostacolata
- [x] **MOD-130** (10:48) `[1 file]` — Corona: governa la coscienza interiore, la spiritualita' profonda. Ci si lavora quando manca la cspacita' di vedere oltre la re…
- [x] **MOD-131** (10:52) `[1 file]` — Cuore: difficolta' a lasciarsi avvicinare sostituire con difficolta a lasciarsi andare...la quale nasce da un profondo meccanis…
- [x] **MOD-132** (10:54) `[1 file]` — Sensazione di non avere le basi sostituirw con assenza di un terreno solido
- [x] **MOD-133** (10:58) `[1 file]` — Piacere e capacita' di godersi le cose sostituire con accogliere le emozioni e vivere la vita con gioia e fluidita'
- [x] **MOD-134** (11:00) `[1 file]` — Niente di accende davvero sostituire con apatia, incapacita' di farsi accendere da passioni desideri o piaceri
- [x] **MOD-135** (11:06) `[1 file]` — Un chakra puo' essere ipoattivo ( chiuso o bloccato): oppure iperattivo (troppo aperto ), in entrambi i casi c'e' disagio
- [x] **MOD-136** (11:10) `[1 file]` — L'obiettivo non e' aprire tutto al massimo, ma riportare ogni centro alla sua misura sostituire con: l'obbiettivo non e' la mas…
- [x] **MOD-137** (11:13) `[1 file]` — Nel trattamento si procede dal basso verso l'alto non ha senso lavorare sulla corona se la radice e' scoperta ELIMINARE QUESTA …
...
- [x] **MOD-181** (18:48) `[2 file]` — Questa foto sostituirla con la seguente
- [x] **MOD-182** (18:54) `[1 file]` — Sostituire con : dal percorso base di 5 sessioni fino al percorso five stars di 14 sessioni per la tua trasformazione completa …
...
- [x] **MOD-314** (18:27) `[1 file]` — (solo allegato)
